...
const URL = "http://localhost:3305/api/abcd/order";
                  ...
                  <form className="needs-validation" novalidate onSubmit={handleSubmit}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-5 my-1">
                        ...
                        <br />
                        <select className="form-select" id="country" required value={order.country}
                      ...
                      <div className="col-md-4 my-1">
                        ...
                        <br />
                        <select className="form-select" id="state" required value={order.state}
                    ...
                    <div className="row gy-3">
                      <div className="col-md-6">
                        <label for="ccfname" className="form-label">
                          Name on card
                        </label>
                        <input
                          name="ccfname"
